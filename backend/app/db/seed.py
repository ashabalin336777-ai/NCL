...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "client_model_id": "qwen3.8-27b-noreason",
    "card_model_id": "qwen3.8-27b-noreason",
    "hint_model_id": "qwen3.6-fp8-noreason",
    "analyst_model_id": "qwen3.8-27b",
...
PLACEHOLDER_SETTINGS: dict[str, set[Any]] = {
    ...
    "client_model_id": {"neuraldeep/qwen2.5-72b-instruct"},
    "hint_model_id": {"neuraldeep/saiga-llama3"},
    "analyst_model_id": {"neuraldeep/qwen2.5-72b-instruct"},
